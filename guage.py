...
#%%
# # Get classified portfolio and open orders
# with get_ib_connection("SNP") as ib:
#     qpf = get_ib_portfolio(account="SNP")  # Use classify's get_ib_portfolio
#     df_pf = classify_pf(qpf)
#     openords = get_open_orders(account_no="SNP", is_active=True)
...
nkd_premium = (df_nkd.xPrice * 100 * df_nkd.qty).sum() if not df_nkd.empty and 'xPrice' in df_nkd.columns else 0
